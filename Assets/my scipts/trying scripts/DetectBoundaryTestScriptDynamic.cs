...
public class DetectBoundaryTestScriptDynamic : MonoBehaviour
{
    ...
    public bool enableEnhancements;
    ...
    private void GenerateNextPoint()
    {
        ...
        if (enableEnhancements)
        {
            ...
            newPoint = new Vector3(lastPoint.x + pathLength * Mathf.Sin(newBeta), 0f, lastPoint.z + pathLength* Mathf.Cos(newBeta));
...
//                interactionPanelObj.transform.localRotation = Quaternion.Euler(new Vector3(0f, 180f, 0f));
            }
        }
    }
